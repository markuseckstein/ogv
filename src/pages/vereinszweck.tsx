...
const VereinszweckPage = ({ data }: PageProps<DataProps>) => {
    return (
        <Layout teaserImage={data.file.childImageSharp.gatsbyImageData} teaserPosition="50% 19%" teaserAltText="Willkommen beim Obst- und Gartenbauverein Pattenhofen Altenthann e.V." backgroundColor={data.file.colors.lightMuted}>
                <h1>Vereinszweck</h1>
                <p>
                ...
                <p>
                    Der Verein ist Mitglied des <a href="http://www.gartenbauvereine.org/" target="_blank">Bayerischen Landesverbandes für Gartenbau und Landespflege</a> und gleichzeitig Mitglied des örtlichen <a href="http://www.kv-gartenbau-nl.de/" target="_blank">Kreis- und Bezirksverbandes</a>.
                </p>
