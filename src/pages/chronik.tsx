...
const KurzchronikPage = ({ data }: PageProps<DataProps>) => {
    return (
        <Layout teaserImage={data.file.childImageSharp.gatsbyImageData} teaserPosition="50% 15%" teaserAltText="Willkommen beim Obst- und Gartenbauverein Pattenhofen Altenthann e.V." backgroundColor={data.file.colors.lightMuted}>
            <h1>Kurzchronik</h1>
            <p>
            ...
            <p>
                ...
                <StaticImage src="../images/kurzchronik-01.jpg" alt={"Kurzchronik 1"}></StaticImage>
            </p>
            <p>
                <StaticImage src="../images/kurzchronik-02.jpg" alt={"Kurzchronik 2"}></StaticImage>
            </p>
            <p>
